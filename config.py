...
NYSE = [
    ...
    "MCD", "ANET", "DVA", "CAT", "GS", "MS", "GE", "BA", "MMM", "CVS", "XLV","MAGS","XLF","NOW","TE",
    "BE", "PLTR", "SOFI", "LLY" # Buraya istediğin her şeyi ekleyebilirsin
]

# BIST 100 Listesi (Tam Liste - .IS uzantılı)
BIST_100 = [
    ...
    "AKSGY.IS", "ALBRK.IS", "BAGFS.IS", "BANVT.IS", "BOSSA.IS", "BRISA.IS", "BVSAN.IS", 
